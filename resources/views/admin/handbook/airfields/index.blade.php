...
<tr class='gradeA'>
	...
	<td class="with-btn" nowrap="">
		<a class="btn btn-success" href="{{ route('airfields.edit',$value) }}"><i class="fas fa-edit"></i> Редактировать</a>
		<form onsubmit="if(confirm('Удалить?')){ return true } else { return false }" action="{{ route('airfields.destroy',[$value->id]) }}" method="post" class="delete-btn" >
...
<div class="container-fluid">
	...
	<br><p><a class="btn btn-lime" href="{{ route('airfields.create') }}"><i class="fas fa-plus-circle"></i> Добавить</a></p>

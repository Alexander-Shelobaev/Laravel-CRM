    ...
    <div class="panel-body">
        ...
        <form action="{{ route('airfields.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="name_airfield_en">
                    Название авиаплощадоки на английском языке <span class="text-theme">*</span>
                    <br>
                    <small>Текст длиною не более 255 символов</small>
                </label>
                <input class="form-control{{ $errors->has('name_airfield_en') ? ' is-invalid' : '' }}" id="name_airfield_en"
                 name="name_airfield_en" type="text"
            ...
            <div class="form-group">
                ...
                <input class="form-control{{ $errors->has('name_airfield_ru') ? ' is-invalid' : '' }}"
                 id="name_airfield_ru" name="name_airfield_ru"
                 type="text" 
            ...
            <div class="form-group">
                ...
                name="latitude" type="text" value="@if(old('latitude')){{ old('latitude') }}@else{{$value->latitude ?? ''}}@endif"
                autofocus>
            ...
            <div class="form-group">
                ...
                <input class="form-control{{ $errors->has('longitude') ? ' is-invalid' : '' }}"
                 ...
                 value="@if(old('longitude')){{ old('longitude') }}@else{{$value->longitude ?? ''}}@endif"
                 autofocus>
            ...
            <div class="form-group">
                <label for="time_zone">
                    Часовой пояс, в котором расположен авиаплощадки
                    <br>
                    <small>Текст длиною не более 16 символов</small>
                </label>
                <input class="form-control{{ $errors->has('time_zone') ? ' is-invalid' : '' }}"
                 id="time_zone" name="time_zone" type="text"

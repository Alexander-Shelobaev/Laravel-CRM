    ...
    <div class="panel-body">
        ...
        <form action="{{ route('states.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                value="@if(old('iso_code_3_state')){{ old('iso_code_3_state') }}@else{{$value->iso_code_3_state ?? ''}}@endif"
                autofocus>
            ...
            <div class="form-group">
                ...
                value="@if(old('solid_currency_id')){{ old('solid_currency_id') }}@else{{$value->solid_currency_id ?? ''}}@endif"
                autofocus>

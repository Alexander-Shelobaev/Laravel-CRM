...
<tr class='gradeA'>
	...
	<td class="with-btn" nowrap="">
		<a class="btn btn-success" href="{{ route('currencies.edit',$value) }}"><i class="fas fa-edit"></i> Редактировать</a>
		<form onsubmit="if(confirm('Удалить?')){ return true } else { return false }" action="{{ route('currencies.destroy',[$value->id]) }}" method="post" class="delete-btn" >
...
<div class="container-fluid">
	...
	<br><p><a class="btn btn-lime" href="{{ route('currencies.create') }}"><i class="fas fa-plus-circle"></i> Добавить</a></p>

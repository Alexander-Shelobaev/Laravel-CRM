...
<form action="{{ route('currencies.store') }}" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<input id="name_currency_en" name="name_currency_en" type="text" class="form-control{{ $errors->has('name_currency_en') ? ' is-invalid' : '' }}" value="{{ old('name_currency_en') }}" autofocus><!-- удалить!!!!!!!!!! required -->
	...
	<div class="form-group">
		...
		<input id="name_currency_ru" name="name_currency_ru" type="text" class="form-control{{ $errors->has('name_currency_ru') ? ' is-invalid' : '' }}" value="{{ old('name_currency_ru') }}" autofocus><!-- удалить!!!!!!!!!! required -->
	...
	<div class="form-group">
		...
		<input id="iso_4217_code_currency_literal" name="iso_4217_code_currency_literal" type="text" class="form-control{{ $errors->has('iso_4217_code_currency_literal') ? ' is-invalid' : '' }}" value="{{ old('iso_4217_code_currency_literal') }}" autofocus><!-- удалить!!!!!!!!!! required -->
	...
	<div class="form-group">
		...
		<input id="iso_4217_code_currency_numeric" name="iso_4217_code_currency_numeric" type="number" class="form-control{{ $errors->has('iso_4217_code_currency_numeric') ? ' is-invalid' : '' }}" value="{{ old('iso_4217_code_currency_numeric') }}" autofocus><!-- удалить!!!!!!!!!! required -->
	...
	<div class="form-group">
		...
		<input id="rounding_currency" name="rounding_currency" type="number" class="form-control{{ $errors->has('rounding_currency') ? ' is-invalid' : '' }}" value="{{ old('rounding_currency') }}" autofocus><!-- удалить!!!!!!!!!! required -->
	...
	<!--<div class="form-group">
		...
		<input id="method_rounding_currency" name="method_rounding_currency" type="number" class="form-control{{ $errors->has('method_rounding_currency') ? ' is-invalid' : '' }}" value="{{ old('method_rounding_currency') }}" autofocus>
	...
	<div class="form-group">
		...
		<input id="unicode" name="unicode" type="text" class="form-control{{ $errors->has('unicode') ? ' is-invalid' : '' }}" value="{{ old('unicode') }}" autofocus><!-- удалить!!!!!!!!!! required -->

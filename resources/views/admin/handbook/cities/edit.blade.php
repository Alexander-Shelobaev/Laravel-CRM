...
<div class="panel panel-inverse">
    <div class="panel-body">
        ...
        <form action="{{ route('cities.update', $value) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control{{ $errors->has('name_city_en') ? ' is-invalid' : '' }}"
                 id="name_city_en" name="name_city_en" type="text"
            ...
            <div class="form-group">
                ...
                <input class="form-control{{ $errors->has('state_id') ? ' is-invalid' : '' }}" id="state_id"
                 ...
                 value="@if(old('state_id')){{ old('state_id') }}@else{{$value->state_id ?? ''}}@endif"
                 autofocus>

        ...
        <form action="{{ route('portfolios.update', $value) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" id="title"
                 name="title" type="text" value="@if(old('title')){{ old('title') }}@else{{$value->title ?? ''}}@endif"
                 autofocus><!-- required -->
                @if ($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <input class="form-control{{ $errors->has('href') ? ' is-invalid' : '' }}" id="href"
                 name="href" type="text" value="@if(old('href')){{ old('href') }}@else{{$value->href ?? ''}}@endif" 
                 autofocus><!-- required -->
                @if ($errors->has('href'))
                <span class="invalid-feedback" role="alert">
            ...
            <img class="old_picture_announce" src="{{asset('/assets-landing/img')}}/{{ $value->img }}"
             alt="{{ $value->headline }}" />
            ...
            <div class="form-group">
                ...
                <div id="img" name="img" class="input-group input-file-picture-announce">
                    <input type="text" class="form-control{{ $errors->has('img') ? ' is-invalid' : '' }}"

...
<ol class="breadcrumb pull-right">
	...
	<li class="breadcrumb-item active"><a href="/admin">Список сервисов</a></li>
</ol>

<h1 class="page-title">Список сервисов</h1>
...
<tr class='gradeA'>
	...
	<td><i class="fas fa-{{ $value->img }}"></td>
	<td>{{ str_limit($value->description,150) }}</td>
	<td class="with-btn" nowrap="">
		<a class="btn btn-success" href="{{ route('services.edit',$value) }}"><i class="fas fa-edit"></i> Редактировать</a>
		<form onsubmit="if(confirm('Удалить?')){ return true } else { return false }" action="{{ route('services.destroy',[$value->id]) }}" method="post" class="delete-btn" >
...
<div class="container-fluid">
	...
	<br><p><a class="btn btn-lime" href="{{ route('services.create') }}"><i class="fas fa-plus-circle"></i> Добавить</a></p>

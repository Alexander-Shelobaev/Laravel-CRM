    ...
    <div class="panel-body">
        ...
        <tr class='gradeA'>
            ...
            <td class="with-btn" nowrap="">
                <a class="btn btn-success" href="{{ route('services.edit',$value) }}">
                    <i class="fas fa-edit"></i> Редактировать
                </a>
                <form onsubmit="if(confirm('Удалить?')){ return true } else { return false }"
                 action="{{ route('services.destroy',[$value->id]) }}" method="post" class="delete-btn" >
        ...
        <div class="container-fluid">
            <p>
                <a class="btn btn-lime" href="{{ route('services.create') }}">

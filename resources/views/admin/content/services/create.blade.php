...
<form action="{{ route('services.store') }}" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<input id="title" name="title" type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" value="{{ old('title') }}" autofocus><!-- удалить!!!!!!!!!! required -->
		@if ($errors->has('title'))
	...
	<div class="form-group">
		...
		<input id="short_text" name="short_text" type="text" class="form-control{{ $errors->has('short_text') ? ' is-invalid' : '' }}" value="{{ old('short_text') }}">
	...
	<div class="form-group">
		<label for="img">Изображение <span class="text-theme">*</span> <br>
			<small>Текст длиною не более 255 символов</small></label>
		<input id="img" name="img" type="text" class="form-control{{ $errors->has('img') ? ' is-invalid' : '' }}" value="{{ old('img') }}">
		@if ($errors->has('img'))
		<span class="invalid-feedback" role="alert">
	...
	<div class="form-group">
		...
		<textarea id="description" name="description" rows="12" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" >{{ old('description') }}</textarea>

        ...
        <form action="{{ route('services.update', $value) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" id="title"
                 ...
                 value="@if(old('title')){{ old('title') }}@else{{$value->title ?? ''}}@endif" autofocus>
                @if ($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <input class="form-control{{ $errors->has('short_text') ? ' is-invalid' : '' }}"
                 id="short_text" name="short_text" type="text"
                 value="@if(old('short_text')){{ old('short_text') }}@else{{$value->short_text ?? ''}}@endif"
                 autofocus>
            ...
            <div class="form-group">
                ...
                <input class="form-control{{ $errors->has('img') ? ' is-invalid' : '' }}"
                 id="img" name="img" type="text" value="@if(old('img')){{ old('img') }}@else{{$value->img ?? ''}}@endif"
            ...
            <div class="form-group">
                ...
                <textarea class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}"
                 id="description" name="description" rows="12">
                    @if(old('description')){{ old('description') }}@else{{$value->description ?? ''}}@endif
                </textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control{{ $errors->has('created_at') ? ' is-invalid' : '' }}"
                 id="created_at" name="created_at" type="text" placeholder="Пример: 2000-12-31 23:59:59"

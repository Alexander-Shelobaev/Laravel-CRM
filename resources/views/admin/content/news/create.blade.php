...
<div class="panel panel-inverse">
    <div class="panel-body">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item active"><a href="/admin">Добавление новости</a></li>
        </ol>
        ...
        <form action="{{ route('news.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                value="{{ old('headline') }}" autofocus><!-- required -->
            ...
            <div class="form-group">
                ...
                class="form-control{{ $errors->has('alias') ? ' is-invalid' : '' }}" value="{{ old('alias') }}">
                @if ($errors->has('alias'))
                <span class="invalid-feedback" role="alert">
            ...
            <div class="form-group">
                ...
                <textarea id="detailed_desc" name="detailed_desc" rows="12" 
                class="form-control{{ $errors->has('detailed_desc') ? ' is-invalid' : '' }}" >
                    {{ old('detailed_desc') }}
                </textarea>
            ...
            <div class="form-group">
                ...
                placeholder="2000-12-31 23:59:59" 

...
<form action="{{ route('users.store') }}" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		<label for="password">Пароль <span class="text-theme">*</span> <br>
	...
	<div class="form-group">
		<label for="password_confirmation">Подтверждение пароля <span class="text-theme">*</span> <br>
			<small>Минимум 8 символов</small>
		</label>
		<input id="password_confirmation" name="password_confirmation" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" value="{{ old('password_confirmation') }}">
		@if ($errors->has('password'))
		<span class="invalid-feedback" role="alert">
	...
	<div class="form-group">
		...
		<div id="avatar" name="avatar" class="input-group input-file-picture-announce">
			<input type="text" class="form-control{{ $errors->has('avatar') ? ' is-invalid' : '' }}" placeholder='Выберите файл' /><!--required-->

...
<tr class='gradeA'>
	...
	<td class="with-btn" nowrap="">
		<a class="btn btn-success" href="{{ route('users.edit',$value) }}"><i class="fas fa-edit"></i> Редактировать</a>
		<form onsubmit="if(confirm('Удалить?')){ return true } else { return false }" action="{{ route('users.destroy',[$value->id]) }}" method="post" class="delete-btn" >

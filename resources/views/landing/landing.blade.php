...
@section('description', 'Большинство поисковых серверов отображают содержимое поля description
 при выводе результатов поиска. Если этого тега нет на странице, то поисковый движок просто 
 перечислит первые встречающиеся слова на странице, которые, как правило, оказываются не очень-то и в тему.')
...
<div id="home" class="content has-bg home">
  ...
  <div class="container home-content">
    ...
    <h3>
      Автоматизация транспортных услуг, заказная разработка, внедрение бизнес-приложений, 
      построение систем электронной коммерции и профессиональные ИТ-услуги, разработка веб-порталов, 
      интернет магазинов и сайтов.
    </h3>
    <a href="#contact" class="btn btn-theme">Cвяжитесь с нами</a>
    <br>
  </div>
</div>
<!-- end #home -->
...
<div id="about" class="content" data-scrollview="true">
  <div class="container" data-animation="true" data-animation-type="fadeInDown">
    ...
    <ul>
      ...
      <li>Автоматизация транспортных услуг – расписания, обработка технологических телеграмм, 
      агентские системы и электронная коммерция;</li>
    ...
    <p>
      Глубокое понимание бизнеса клиента, выявление и тщательный анализ проблем, препятствующих его развитию, 
      позволяет предложить оптимальные варианты решения наиболее актуальных бизнес-задач и, в рамках каждого 
      проекта, достичь максимального экономического результата для клиента.

      Эксперты «Software Provider» Ltd постоянно совершенствуют свои знания и имеют на сегодняшний день свыше 
      50 действующих сертификатов ведущих мировых производителей программного обеспечения. Работа каждого из 
      них является образцом профессионализма во всех сферах деятельности и видах услуг, которые мы оказываем.

      «Software Provider» Ltd является надежным деловым партнером и строит взаимоотношения с клиентами на 
      долговременной и взаимовыгодной основе. Нашими клиентами и партнерами являются крупнейшие предприятия 
      и организации России, среди которых: ОАО Аэрофлот, Государственная корпорация Росатом, IBM и др..
    </p>
  </div>
</div>
<!-- end #about -->
...
<div id="milestone" class="content bg-black-darker has-bg" data-scrollview="true">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-3 col-sm-3 milestone-col">
        <div class="milestone">
          <div class="number" data-animation="true" data-animation-type="number" data-final-number="20">
            10
          </div>
      ...
      <div class="col-md-3 col-sm-3 milestone-col">
        <div class="milestone">
          <div class="number" data-animation="true" data-animation-type="number" data-final-number="50">
            0
          </div>
      ...
      <div class="col-md-3 col-sm-3 milestone-col">
        <div class="milestone">
          <div class="number" data-animation="true" data-animation-type="number" data-final-number="112+">
            0
          </div>
...
<div id="team" class="content" data-scrollview="true">
  <div class="container">
    ...
    <p class="content-desc">
      Техническая команда «Software Provider» Ltd обладает высоким профессионализмом — более 50 сертификатов, 
      и использует в работе следующие IT технологии:
    </p>
    <div class="row">
      <div class="col-md-6">
        ...
        <ul>
          ...
          <li>SmartVista — интегрированная полнофункциональная система, предназначенная для организации и 
            ведения всего спектра операций электронного бизнеса. Продукты SmartVista сертифицированы 
          международными платежными системами Visa, MasterCard, American Express, Diners Club...;</li>
  ...
  <div class="container" data-animation="true" data-animation-type="fadeInLeft">
    <div class="row">
      <div class="col-md-12 quote">
        <i class="fa fa-quote-left"></i> Доводим проекты до конца! <i class="fa fa-quote-right"></i>
        <small>Девиз <span class="text-theme">«Software Provider»</span> Ltd</small>
      </div>
    </div>
  </div>
</div>
...
<div id="service" class="content" data-scrollview="true">
  <div class="container">
    ...
    <!-- <p class="content-desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit, 
...
<div id="work" class="content" data-scrollview="true">
  <div class="container" data-animation="true" data-animation-type="fadeInDown">
      ...
      <p class="content-desc">
        ...
        eros dolor,<br>sed bibendum turpis luctus eget
      </p>
                ...
                <div class="work">
                    ...
                    <div class="desc">
                        <div class="work-cont-desc">
                            ...
                            <span class="desc-btn"><a href="{{ $value->href }}" 
                              class="btn btn-theme btn-sm" target="_blank">Подробнее</a></span>
                        </div>
                    </div>

                    <div class="image">
                        <a href="#"><img src="{{asset('/assets-landing/img/'.$value->img)}}" 
                          alt="{{ $value->title }}" /></a>
                    </div>
...
<div id="client" class="content has-bg bg-green" data-scrollview="true">
    ...
    <div class="container" data-animation="true" data-animation-type="fadeInUp">
        ...
        <!-- begin carousel -->
        <div class="carousel testimonials testimonials-client slide" data-ride="carousel" 
            ...
            <div class="carousel-inner text-center">
                ...
                <div class="item active">
                    <blockquote>
                      ...
                      Специалисты компании «Software Provider» Ltd - отзывчивые и<br>
                      компетентные сотрудники с опытом работы.<br>
                      Надеюсь на дальнейшее не менее плодотворное<br>
                      сотрудничество!
                ...
                <div class="item">
                    <blockquote>
                      <i class="fa fa-quote-left"></i>
                      Сильная и профессиональная команда.<br>
                      Действительно слышат пожелания клиентов<br>
...
<div id="partners" class="content" data-scrollview="true">
    ...
    <div class="container" data-animation="true" data-animation-type="fadeInDown">
        ...
        <p class="content-desc">
          Наши партнеры располагают значительным опытом и большими ресурсами,
          позволяющими осуществить любой совместный проект:
        </p>

        <ul>
          <li>
            <a href="http://www.ibm.com/ru-ru/" target="_blank">IBM</a> — транснациональная 
            корпорация со штаб-квартирой в Армонке, штат Нью-Йорк (США), один из крупнейших в мире 
            производителей и поставщиков аппаратного и программного обеспечения, а также ИТ-сервисов 
            и консалтинговых услуг. Лучший мировой поставщик интеграционных платформ.
          </li>
          <li>
            <a target="_blank" href="http://bpcbankingtech.com/ru">БПЦ Банковские Технологии</a> 
            - основана в 1995 году. Архитектор, разработчик и вендор семейства продуктов SmartVista, 
            которая предназначена для решения всех задач, связанных с управлением сетями банкоматов, 
            тарификацией и выставлением счетов, мобильными и бесконтактными платежами, взаиморасчетами, 
            приемом платежей в торговых точках, эмиссией карт, эквайрингом, микрофинансированием и 
            обработкой электронных платежей.
          </li>
          <li>
            <a title="РБС" target="_blank" href="http://www.rbspayment.ru/">Рунет Бизнес Системы (РБС)</a> 
            - работает на рынке интернет-эквайринга с 2000-го года. РБС предоставляет услуги 
            интернет-эквайринга пластиковых карт международных платежных систем с использованием 
            современных технологий и международных стандартов электронных платежей. РБС предлагает 
            весь необходимый функционал для банков, торгово-сервисных предприятий, реализующих 
            товары или услуги в интернете, позволяя принимать платежи в интернет-магазинах с 
            помощью пластиковых карт международных платежных систем.
          </li>
          <li>
            <a href="http://www.dis-group.ru/" target="_blank">Data Integration Software</a> — 
            авторизованный дистрибьютор корпорации <a href="https://www.informatica.com/" 
            target="_blank">Informatica</a> в России и странах СНГ. С 2005 года компания Data Integration 
            Software предлагает своим партнерам и заказчикам в России и СНГ лидирующую промышленную 
            платформу для интеграции и обеспечения качества корпоративных данных, благодаря которой 
            компании по всему миру обеспечивают доступ, интегрируют, визуализируют данные, осуществляют 
            аудит информационных активов для повышения эффективности своего бизнеса, увеличения доходов 
            клиентов и выполнения требований регулирующих органов.
          </li>
          <li>
            <a href="http://www.asoft.ru/" target="_blank">ASoft</a> — ведущий российский разработчик 
            программного обеспечения. Поставщик ряда собственных программных продуктов (ASoft CRM, 
            ASoft Contact Manager, ASoft Collaboration, ASoft Doc и др.).
          </li>
          <li>
            <a href="http://www.teamwox.com/ru/about" target="_blank">MetaQuotes Software Corp.</a> 
            начала свою деятельность в 2000 году как разработчик программного обеспечения для 
            финансовых рынков. На настоящее время приобрела известность, как производитель 
            <a href="http://www.teamwox.com/" target="_blank">TeamWox</a> — лучшей российской 
            системы автоматизации управления СМБ-бизнесом.
          </li>
     </ul>
...
<div id="client" class="content has-bg bg-green" data-scrollview="true">
    ...
    <div class="container" data-animation="true" data-animation-type="fadeInUp">
        ...
        <!-- begin carousel -->
        <div class="carousel testimonials testimonials-partners slide" data-ride="carousel" 
        ...
        <div class="row row-space-10">
            ...
            <div class="newslist-container col-xs-6 col-sm-6 col-md-4" id="">
                <div class="newslist-block">
                    ...
                    <div class="image">
                        <a href="{{ route('news',[$value->alias]) }}">
                          <img src="{{ asset('/assets-landing/img/'.$value->picture_announce) }}">
                        </a>
                    </div>

                    <h3 class="newslist-title">
                      <a href="{{ route('news',[$value->alias]) }}">{{ $value->headline }}</a>
                    </h3>
                    ...
                    <div class="row">
                      <div class="col-xs-12">
                        <div class="newslist-date">
                          <small>
                            <i class="fa fa-calendar-o"></i> {{ $value->created_at->format('d F Y') }}
                          </small>
                        </div>
                      </div>
                    </div>
        ...
        <div class="carousel testimonials slide" data-ride="carousel" id="testimonials">
            ...
            <div class="carousel-inner text-center">
                ...
                <div class="item active">
                  ...
                  <div class="name">
                    Международный авиационный <span class="text-theme">ИТ-форуме 2018</span>
                  </div>
                </div>
                <!-- end item -->
                <!-- begin item -->
                ...
                <div class="item">
                  ...
                  <div class="name">
                    Конференция <span class="text-theme">«Электронный инструментарий промышленной кооперации»</span>
                  </div>
                </div>
                <!-- end item -->
            </div>
        ...
        <table class="tableinfooter">
          <tbody>
            ...
            <tr>
              ...
              <td></td>
              <td class="top">
                <a href="http://www.software-provider.ru/" target="_blank">http://www.software-provider.ru/</a>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td></td>
              <td>
                Московский РФ АО «Россельхозбанк»<br>

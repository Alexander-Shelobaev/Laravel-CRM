...
<div id="header" class="header {{ $headerClass }}">
	...
	<div class="navbar-header">
		<a href="{{ route('admin') }}" class="navbar-brand"><span class="navbar-logo"></span> <b>Проект</b></a>
		@if (!$sidebarHide)
	...
	<ul class="navbar-nav navbar-right">
		...
		<li class="dropdown navbar-user">
			<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
				...
				<span class="d-none d-md-inline">Гость</span> <b class="caret"></b>
			</a>
		...
		<li class="dropdown navbar-user">
			<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
				<img src="{{ asset('/assets/img/user/'.Auth::user()->avatar) }}" alt="" /> 
				<span class="d-none d-md-inline">{{Auth::user()->name}}</span> <b class="caret"></b>
			</a>
			<div class="dropdown-menu dropdown-menu-right">
				<a href="javascript:;" class="dropdown-item">Редактировать профиль</a>
